...
<link rel="stylesheet" type="text/css" href="sty-login.css" media="screen" />
...
<div id ="sidebar">
			<div class="login2">
				...
				<div class ="middle ">
					<form name="loginform" action="logfrm.jsp" onsubmit="return validateLoginForm()">  <!--action= "login1.php" method="post" -->
						Name: <input type="text" value="" name="name" size="18"/><br>
                                                    <input type="text" disabled="disabled" value="" style="color: red;border: none;" name="nameError" /><br><br>
						Password:     <input type="password" name="password" size="18"  /><br>
						<input type="text" name="passError" disabled="disabled" style="color:red;border: none;"/><br>
